...
# @Last Modified time: 2024-08-28 14:46:04
...
class DateFuncNew:
    ...
    def get_start_and_end_range(self, start_date: str, end_date: str, days: int = 0):
        date_ranges = self.get_date_ranges(start_date, end_date, days=days)
        date_range = [date[0] for date in date_ranges]
        # dlogger.info(f"unit: {self.unit}, start_days ({start_days}), end_days: {end_days} !!!")
        return date_range
